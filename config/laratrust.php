...
return [
    ...
    */
    'middleware' => [
         ...
         */
        'handling' => 'abort',
        // 'middleware_params'   => '/profile',       // Change this to the route you need
        ...
        'handlers' => [
            ...
            'redirect' => [
                ...
                'message' => [
                    'key' => 'error',
                    'content' => 'You are not authorised to access this page. You may contact the Admin if you think this is a mistake'
                ]
            ]
        ]
    ],
