@extends('layouts.app', [
    'namePage' => 'accountant Management',
    'activePage' => 'accountant-management',
])
@section('content')
<div class="jay-header jay-header-lg"><h3 class="jay-title">Accountants</h3></div>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            ...
            <small> This is the list of all the accountants </small>
            &nbsp; &nbsp; &nbsp;
          ...
          <div class="card-body">
            ...
            @else
              <div style="text-align: center" >
                <h6 class ="emptyList"><b>No accountant created yet</b></h6>
              </div>
            @endif
          </div>
          <!-- end content-->
