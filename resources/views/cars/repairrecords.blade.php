            ...
            <img src="{{asset('storage/images/car/'.$car_thumbnails->first()['name'])}}" alt="Car Thumbnail" style = "height:250px; width:100%"  />
              <br>
                        {{-- <div id="carouselExampleControls" class="carousel slide" data-interval="4000" data-ride="carousel" >
                            <div id="productimagewrap" class="preview-pic tab-content">
                                @foreach ($car_thumbnails as $car_thumbnail)
                                    <div class="carousel-item tab-pane @if($car_thumbnail === $car_thumbnails[0]) active @endif " id="pic-{{$car_thumbnail->id}}">
                                        <img src="{{asset('storage/images/car/'.$car_thumbnail->name)}}" alt="jj" style = "height:250px; width:100%"  />
                                    </div>
                        ...
                        <div style="padding-left:50px">
                            ...
                            <li class=""><a id="pic-{{$car_thumbnail->id}}" data-target="#pic-{{$car_thumbnail->id}}" data-toggle="tab">
                                <img src="{{asset('storage/images/car/thumbnail/'.$car_thumbnail->name)}}" alt="aa" style="padding-right: 20px; padding-top:10px; height:50px; width:80%" /></a></li>
                                @endforeach
                            </ul> <br>
                        </div> --}} 
            <div style="text-align: center; margin-left:-15%"> 
              {{-- <div class="action"> --}}
                ...
                @if(Auth::user()->roles->first()->id === 1 || Auth::user()->roles->first()->id === 2)
                  <a class="btn btn-primary" style="border-radius:30px; color:white; padding:5px 15px" type="button" data-toggle="modal" data-target="#fuelpurchase">
                    Add Fuel &nbsp; <i class="fa fa-tint" aria-hidden="true"></i>
                  </a> 
                  <a class="btn btn-primary" style="border-radius:30px; color:white; padding:5px 15px; background-color: brown" type="button" data-toggle="modal" data-target="#repair">
              ...
              {{-- <div class="action">
                  <button class="add-to-cart btn btn-default" type="button"><a href="/book-car/{{$car->id}}" style="color: white; text-decoration:none"> Book Now</a></button>
                  @if(Auth::user()->roles->first()->id === 1 || Auth::user()->roles->first()->id === 2)
                      <a href="" class="btn btn-primary" style="border-radius:30px; padding:5px 15px" type="button" data-toggle="modal" data-target="#fuelpurchase">
                          Add Fuel &nbsp; <i class="fa fa-tint" aria-hidden="true"></i>
                      </a> 
                      <a href="" class="btn btn-primary" style="border-radius:30px; padding:5px 15px; background-color: brown" type="button" data-toggle="modal" data-target="#repair">
                          Repair &nbsp; <i class="fa fa-wrench" aria-hidden="true"></i>
                      </a>
                  @endif
              </div> --}}
        ...
        @if (Auth::user()->can('admin') || Auth::user()->can('accountant'))
                ...
                @else
                  <div style="text-align: center" >
                    <h6 class ="emptyList"><b>This car didn't embark on any trip in the last 30 days </b></h6>
                  </div>
                @endif
                ...
                <h4 class="card-title"><b>Fuel Records for  {{date('F')}}</b></h4>
                <div class="form-inline pull-right"> 
                ...
                <small> This is the list of all the fuel recordFuels for this period </small>
                &nbsp; &nbsp;
                {{-- <div>
                    <a href="/car/car->id"  style="margin-top: -10px; float: right; text-decoration:none">View trips for the last 30 days </a>
                </div> --}}
              ...
              @else
                <div style="text-align: center" >
                  <p class ="emptyList"><b>No Fuel Record for this Period </b></p>
                </div>
              @endif
            ...
            <div> 
                <h4 style="text-align:center" class="product-title">Car Repair Records</h4>
                  <hr style="width: 75%">
                <h4 class="card-title"><b>Records for {{date('F Y', strtotime($month))}}</b></h4>
                <div class="form-inline pull-right"> 
