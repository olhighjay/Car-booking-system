...
<div class="jay-header jay-header-lg"><h3 class="jay-title">Vehicles</h3></div>
	...
	<div class="container">
        ...
        @if (Auth::user()->can('admin') || Auth::user()->can('accountant'))
            ...
            <hr style="width: 75%">
            <h4 class="card-title"> <b>Trips Records for {{date('F Y', strtotime($month))}}</b> </h4>
            ...
            @else
              ...
              <h6 style="color: slategray"><b>This car didn't embark on any trip during this period </b></h6>
              </div>
            @endif
